class APB_master_stability_err_driver extends APB_master_driver;
    `uvm_component_utils(APB_master_stability_err_driver)

    function new(string name = "APB_master_stability_err_driver", uvm_component parent = null);
