class APB_TC_BSC_002_test extends APB_base_test;
    `uvm_component_utils(APB_TC_BSC_002_test)

    function new(string name = "APB_TC_BSC_002_test", uvm_component parent = null);
    ...
    virtual task run_phase(uvm_phase phase);
        APB_master_single_read_seq m_seq;
        APB_slave_zero_wait_seq    s_seq;
        phase.raise_objection(this);
        m_seq = APB_master_single_read_seq::type_id::create("m_seq");
