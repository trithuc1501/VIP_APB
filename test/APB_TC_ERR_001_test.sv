class APB_TC_ERR_001_test extends APB_base_test;
    `uvm_component_utils(APB_TC_ERR_001_test)


    function new(string name = "APB_TC_ERR_001_test", uvm_component parent = null);
