class APB_TC_TIM_003_test extends APB_base_test;
    `uvm_component_utils(APB_TC_TIM_003_test)

    function new(string name = "APB_TC_TIM_003_test", uvm_component parent = null);
    ...
    virtual task run_phase(uvm_phase phase);
        APB_master_random_delay_seq m_seq;
        APB_slave_random_wait_seq   s_seq;
        phase.raise_objection(this);
        m_seq = APB_master_random_delay_seq::type_id::create("m_seq");
